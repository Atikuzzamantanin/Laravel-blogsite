    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 offset-1">
                ...
                <a href="{{ url('admin/category/create') }}" class="btn btn-info"><i
                        class="fa fa-plus"></i> Category Create</a>
            </div>
        </div>
    </div><br>
            ...
            <div class="row">
                <div class="col-md-10 offset-1">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <form action="{{ route('category.update',[$updateCategory->id]) }}"
                            method="POST">
                            @csrf
                            @method("PUT")
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="des1"
                                        rows="4">{{ $updateCategory->description }}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
